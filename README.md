...
One-click Railway template for [Skardi](https://github.com/SkardiLabs/skardi) v0.4.0 — an open-source data plane for AI agents that turns parameterized SQL into REST endpoints.

[![Deploy on Railway](https://railway.com/button.svg)](https://railway.com/new/template)

## Features

- `skardi-server` v0.4.0 (image: `ghcr.io/skardilabs/skardi/skardi-server:0.4.0`)
...
```bash
docker build -t skardi-railway:0.4.0 .
docker run --rm -e PORT=8080 -p 8080:8080 -v skardi-data:/data skardi-railway:0.4.0
